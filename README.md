...
```sh
grep -rl 'mock' ./ | xargs sed -i '' 's/mock/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with mock
...
Want to contribute? Ping us on `mock` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/mock.git
    cd mock
    ```
...
- [mock integration Documentation](https://docs.vuestorefront.io/mock)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `mock` channel on [our Discord](discord.vuestorefront.io).
